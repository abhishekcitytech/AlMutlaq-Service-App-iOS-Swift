...
//  AlMutlaqRealEstate
//
//  Created by Sandipan on 19/07/18.
//  Copyright © 2018 SANDIPAN. All rights reserved.
//

import UIKit

class CSMyAccount: UIViewController,UITextFieldDelegate
{
 var loadingCircle = UIView()
    ...
    @IBOutlet var lblProfileHeader: UILabel!
    ...
    override func viewDidLoad()
    {
        ...
        lblProfileHeader.text="  Customer Service Profile"
        ...
        //txtAddress.text="Unit-1308,Jumeirah Bay Tower,Dubai"
    ...
    func setupBorder() -> Void
    {
       /* viewtop.layer.shadowColor = UIColor.lightGray.cgColor
        ...
        border.frame = CGRect(x: 0, y: lblProfileHeader.frame.size.height - width, width: lblProfileHeader.frame.size.width+100, height: lblProfileHeader.frame.size.height)
        border.borderWidth = width
        lblProfileHeader.layer.addSublayer(border)
        lblProfileHeader.layer.masksToBounds = true
